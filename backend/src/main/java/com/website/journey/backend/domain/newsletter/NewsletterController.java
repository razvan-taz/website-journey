...
public class NewsletterController {
    ...
    public ResponseEntity<Void> unsubscribe(@RequestParam("token") UUID token) {
        newsletterRepository.findByUnsubscribeToken(token).ifPresent(newsletterRepository::delete);
        return ResponseEntity.ok().build();
    }
